...
int main()
{
    ...
    f.calculateJacobianParameters(input.data(), jacobianParameters1);
    f.Function::calculateJacobianParameters(input.data(), jacobianParameters2);
    ...
    for (size_t i = 0; i < jacobianParameters1.getRows(); ++i)
    {
        for (size_t j = 0; j < jacobianParameters1.getCols(); ++j)
        {
            if (abs(jacobianParameters1(i, j) - jacobianParameters2(i, j)) > 0.001)
            {
                ...
                cout << "Truth:" << endl;
                printMatrix(cout, jacobianParameters1);
    ...
    f.calculateJacobianInputs(input.data(), jacobianInputs1);
    f.Function::calculateJacobianInputs(input.data(), jacobianInputs2);
    ...
    for (size_t i = 0; i < jacobianInputs1.getRows(); ++i)
    {
        for (size_t j = 0; j < jacobianInputs1.getCols(); ++j)
        {
            if (abs(jacobianInputs1(i, j) - jacobianInputs2(i, j)) > 0.001)
            {
                ...
                cout << "Truth:" << endl;
                printMatrix(cout, jacobianInputs1);
    ...
    for (size_t index = 0; index < f.getOutputs(); ++index)
    {
        ...
        f.calculateHessianParameters(input.data(), index, hessianParameters1);
        f.Function::calculateHessianParameters(input.data(), index, hessianParameters2);
        ...
        for (size_t i = 0; i < hessianParameters1.getRows(); ++i)
        {
            for (size_t j = 0; j < hessianParameters1.getCols(); ++j)
            {
                if (abs(hessianParameters1(i, j) - hessianParameters2(i, j)) > 0.001)
                {
                    ...
                    cout << "Truth:" << endl;
                    printMatrix(cout, hessianParameters1);
    ...
    for (size_t index = 0; index < f.getOutputs(); ++index)
    {
        ...
        f.calculateHessianInputs(input.data(), index, hessianInputs1);
        f.Function::calculateHessianInputs(input.data(), index, hessianInputs2);
